...
def runner(exp_folder, exp, region):
    ...
    hidden_s = 0.1
    hidden_lt = "sep"
    run_1(exp_folder, exp, c_size, c_filters, cd2x, hidden_t, hidden_s, hidden_lt, region)
...
def run_1(exp_folder, exp, c_size, c_filters, cd2x, hidden_t, hidden_s, hidden_lt, region):
    name = f'multieval_exp5_{region}'
    exp = f"{exp}"
