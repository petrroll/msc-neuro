...
def runner(run, learning_rate):
    run_1(run, learning_rate)

#
# 1
# Baselineshort_2: different lrs
#
def run_1(run, learning_rate):
    ...
    def get_training_params():
        return {'batch_size': 16, 'use_gpu': False, 'epochs_summary': 100, 'epochs_training': 5000, 'learning_rate': learning_rate}
