...
#
# 1
# Default biases initialization is zeros -> try to init them with `trunc_normal`
#
name = 'baselineshort_2_exp41_1normIms_Dog9xN0x2N_LxSpxSp_Wn_Btn_Nonorm_1e3x16x5000'
