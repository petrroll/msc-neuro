...
#
# based on bl2:
# - added bias initialization to `trunc_normal` (experiments_1/bs2_exp41)
# - better LR 0.001 (experiments_2/bs2_exp1x3)
def run_1(exp_folder, exp):
    name = 'baseline3_1normIms_Dog9xN0x2N_LxSpxSp_Wn_Btn_Nonorm_0.001x16x35000'
    ...
    def get_training_params():
        return {'batch_size': 16, 'use_gpu': False, 'epochs_summary': 100, 'epochs_training': 35000, 'learning_rate': 0.001}
